...
This works (the APA-style figure note shows correctly; @fig-mtcars2; @fig-example1).
...
This doesn't work (the APA-style figure note does not show; @fig-mtcars; @fig-example2).
