...
citation:
  ...
  #issued: YEAR
  #doi: INSERT
  url: https://isaactpetersen.github.io/apaquartoReprex/
---
...
This works (the APA-style figure note shows correctly; @fig-mtcars; @fig-example1).
...
This doesn't work (the APA-style figure note does not show; @fig-mtcars2; @fig-example2).

{{< embed notebooks/analyses.qmd#fig-mtcars2 >}}

<!-- {{< embed notebooks/analyses.qmd#fig-example2 >}} -->
